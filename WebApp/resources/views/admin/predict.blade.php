                ...
                <form id="predictionForm">
                    ...
                    @if($models->count() === 0)
                        <div class="no-models-alert">
                            ...
                            <p class="mb-0 mt-2">Please add/activate model in Model Management first.</p>
                        </div>
                    @endif
        ...
        <div class="card guidelines-card">
            ...
            <div class="card-body">
                <div class="parameter-item mb-3">
                    ...
                    <p class="mb-0 small">
                        Use these inputs to test active models and monitor Hydrogen Production Rate trends.
                    </p>
                </div>
