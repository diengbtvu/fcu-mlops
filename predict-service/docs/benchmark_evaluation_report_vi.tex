...
\subsection{Ví dụ thật: baseline raw claim trước và sau normalize}
Baseline không gọi model mới; nó lấy từ
\filepath{predict-service/app/reports/KNN_Main_Dataset_20260421/llm_explanations.json}
rồi chuyển sang generation benchmark trong
\filepath{predict-service/benchmarking/baseline_adapter.py:962-997}.
