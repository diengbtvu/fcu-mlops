...
def _artifact_row(
    ...
    row = {
        **metadata,
        ...
        "claim_alignment_error_rate": _metric_value(score_row, "claim_alignment_error_rate"),
        "missing_value_rate": _metric_value(score_row, "missing_value_rate"),
        "unknown_variable_rate": _metric_value(score_row, "unknown_variable_rate"),
        "extraction_drop_rate": _metric_value(score_row, "extraction_drop_rate"),
